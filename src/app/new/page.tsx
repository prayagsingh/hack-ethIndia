...
export default function Page() {
  return (<div className="flex flex-col items-center ">
    ...
    <div className="w-[75vw] bg-white border border-black border-2 p-10 rounded-lg items-center flex flex-col">
      <div className="flex-col items-center">Thank you for reaching out. In order to verify your content, we require some<br />
        essential details from your end. Kindly provide the following information:</div>
      <div className="w-[80%] flex flex-col mt-10 gap-y-5">
        ...
        <div className="w-full gap-y-2">
          <div className="font-bold">Supporting Documents (Proof of Ownership)</div>
          <div>Attach any relevant documents, screenshots, or evidence supporting your claim.</div>
